							...
							<div style="margin: -60px 0 20px 1100px;">
								<div class="btn-group me-2">
									<a class="btn btn-primary btn-sm"
										href="http://localhost:8080/JPAProject/admin/add-category"
										style="font-size: 15px; padding: 8px 16px;">Thêm</a>
								</div>
								<div class="btn-group">
									<a href="http://localhost:8080/JPAProject/admin/category" class="btn btn-warning btn-sm" 
											...
											<table id="recent-orders"
												...
												<thead>
													<tr>
														...
														<th class="border-top-0" style="width: 25%;">Tên hãng sản xuất</th>
														<th class="border-top-0" style="width: 15%;">Trạng thái</th>
														<th class="border-top-0" style="width: 30%;">Ảnh</th>
